...
// Stable Cloudflare global permission group IDs (from /user/tokens/permission_groups)
const CF_PERM_IDS = [
  'e086da7e2179491d91ee5f35b3ca210a', // Workers Scripts Write
  'f7f0eda5697f475c90846e879bab8666', // Workers KV Storage Write
  'c1fde68c7bcc44588cdb6ddbc16d6480', // Account Settings Read
  'c8fed203ed3043cba015a93ad1616f1f', // Zone Read
  '28f4b596e7d643029c524985477ae49a', // Workers Routes Write
]

function buildPrefillUrl() {
  const params = CF_PERM_IDS.map((id, i) => 'permissionGroups[' + i + '][id]=' + encodeURIComponent(id))
  return CF_TOKENS_PAGE + '?' + params.join('&')
}
      ...
      <div className="glass-card p-5">
        ...
        <div className="mt-4 pt-4 border-t border-slate-800/50">
          <button
            ...
            className="w-full p-4 rounded-xl bg-gradient-to-r from-brand-500/10 to-brand-600/10 border border-brand-500/30 hover:border-brand-500/50 hover:from-brand-500/20 hover:to-brand-600/20 transition-all flex items-center gap-3 group"
          >
